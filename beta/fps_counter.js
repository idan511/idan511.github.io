...
if(location.hostname != "idanalper.in") {
    ...
    fpsCounteObject.style.zIndex = 5;
    ...
    fpsCounteLabel.style.webkitTextStrokeWidth = "1px"
    fpsCounteLabel.style.webkitTextStrokeColor = "black"
    fpsCounteLabel.style.color = "white"
    fpsCounteLabel.style.fontWeight = "bold"
    refreshLoop()
}
